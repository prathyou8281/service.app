    ...
    <div className="min-h-screen bg-slate-50 flex flex-col lg:flex-row pt-0">
      ...
      <aside className={`bg-white border-r border-slate-200 transition-all duration-300 ${sidebarOpen ? "w-72" : "w-20"} flex flex-col z-20`}>
        <div className="p-8 flex items-center justify-between">
          {sidebarOpen && <h1 className="text-xs font-black uppercase tracking-[0.2em] text-blue-600">Control Panel</h1>}
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest mt-1">Super Admin Unit</p>
              </div>
            </div>
          </div>
        </header>
