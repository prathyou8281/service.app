...
export default function TechnicianRegisterPage() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        if (!selectedCategory || !selectedServiceType || selectedSkills.length === 0) {
            setError("Deployment failed: Missing professional classifications.");
            return;
        }
    ...
    return (
        <div className="min-h-screen bg-[var(--background)] flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/5 bg-slate-900 p-12 lg:p-24 flex flex-col justify-between text-white relative overflow-hidden">
                <div className="relative z-10">
                    ...
                    <h1 className="text-4xl lg:text-6xl font-black leading-tight mb-8">
                        Expertise<br />
                        <span className="text-emerald-500">Recognized.</span>
                    </h1>
                    <p className="text-slate-400 text-lg max-w-sm font-medium mb-16 leading-relaxed">
                        Join our elite network of professional technicians. Get access to verified job requests and enterprise tools.
                    </p>
                ...
                <div className="relative z-10 pt-20">
                    <p className="text-slate-600 text-[10px] font-black uppercase tracking-[0.2em]">© 2026 TechHub Systems • Field Operations Unit</p>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center p-8 lg:p-24 bg-slate-50">
                ...
                >
                    <div className="mb-12">
                        <h2 className="text-3xl font-black text-slate-900 tracking-tight mb-3">Technician Application</h2>
                        <p className="text-emerald-600 font-bold uppercase text-[10px] tracking-[0.2em]">Deploy your professional profile</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-8">
                        ...
                        <div className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className={selectedCategory ? "text-slate-900" : "text-slate-400 uppercase text-[10px] tracking-widest"}>
                                                {selectedCategory?.name || "Global Category"}
                                            </span>
                                        </div>
                                ...
                                <div className="space-y-2.5 relative" ref={stRef}>
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Terminal Logic</label>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className={selectedServiceType ? "text-slate-900" : "text-slate-400 uppercase text-[10px] tracking-widest"}>
                                                {selectedServiceType?.name || "Service Type"}
                                            </span>
                                        </div>
                            ...
                            <div className="space-y-4 relative" ref={skillRef}>
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Skill Cluster Integration</label>

                                <div className="flex flex-wrap gap-2 min-h-[50px] p-4 bg-slate-50/50 border border-dashed border-slate-200 rounded-[2rem]">
                                    {selectedSkills.length === 0 && <span className="text-[10px] font-black uppercase tracking-widest text-slate-300 italic p-2">No skillsets assigned...</span>}
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-slate-400 uppercase text-[10px] tracking-widest">Toggle Database Skills Pool</span>
                                    </div>
                                        ...
                                        <motion.div initial={{ opacity: 0, y: 10, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 10, scale: 0.95 }} className="absolute z-50 left-0 right-0 mt-3 bg-white border border-slate-100 rounded-[2rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.15)] overflow-hidden">
                                            <div className="p-4 border-b border-slate-50 bg-slate-50/50">
                                                <input
                                                    ...
                                                    placeholder="Search specialized nodes..."
                                                    value={skillSearch}
                        ...
                        <div className="pt-6">
                            ...
                            >
                                {loading ? <div className="w-5 h-5 border-2 border-white/20 border-t-white rounded-full animate-spin" /> : <>Activate Operational Unit <ArrowRight className="w-4 h-4" /></>}
                            </button>
                        </div>
                    </form>
