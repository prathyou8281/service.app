...
export default function Nav({
  ...
  // ❌ Pages where Login/Register should NOT show
  ...
  // ✅ Become Vendor visible ONLY on these pages
    ...
    >
      <nav className="mx-auto flex h-16 max-w-7xl items-center px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="ml-auto flex items-center gap-4">
          {/* ✅ Become Vendor (Desktop) */}
          {showVendorButton && (
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="hidden md:block btn-primary px-6 py-2 text-sm font-semibold"
